...
export async function GET(){
 ...
 ]);return Response.json({profile:{name:u.displayName,email:u.email},appointments:appointments.results,orders:orders.results,enrollments:enrollments.results,tickets:tickets.results,invoices:invoices.results,reports:reports.results,certificates:certificates.results,payments:payments.results,files:files.results})
}
