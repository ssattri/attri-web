...
const modules=["overview","analytics","notifications","seo-manager","database","data-managers","permissions","pages","blog","testimonials","faqs","projects","leads","appointments","consultancy","products","product-categories","commerce","courses","course-categories","learning","support","finance","reports","operations","automation","media","vault","settings"];
