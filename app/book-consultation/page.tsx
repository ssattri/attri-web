...
export default function BookingPage(){
  const serviceSchema={"@context":"https://schema.org","@type":"Service",name:"Attri Associates Consultation",provider:{"@type":"Organization",name:"Attri Associates & Vastu Consultants",url:"https://www.attriassociates.com"},areaServed:"IN",serviceType:["Scientific Vastu consultation","Architecture consultation","Structural design consultation","Interior design consultation"]};
  return <main className="booking-page"><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(serviceSchema)}}/>
