...
export default function BookingForm(){
  ...
  return <form className="booking-form" onSubmit={submit}>
    ...
    <div className="booking-grid"><label>Service *<select name="service" required><option value="">Select service</option><option>Residential Vastu</option><option>Commercial Vastu</option><option>Industrial / Factory Vastu</option><option>Architecture Planning</option><option>Structural Design</option><option>Interior Design</option><option>Project Review</option></select></label><label>Consultation mode *<select name="consultationMode" required><option value="">Select mode</option><option>Video Consultation</option><option>Phone Consultation</option><option>Chat Consultation</option><option>Office Meeting</option><option>Site Visit</option></select></label><label>Consultant preference<select name="consultantPreference"><option>Any available consultant</option><option>Senior Vastu Consultant</option><option>Architecture Consultant</option><option>Interior & Design Consultant</option></select></label><label>Project type<select name="projectType"><option>New Construction</option><option>Existing Property</option><option>Renovation</option><option>Drawing Review</option><option>Not sure yet</option></select></label><label>Booking type<select name="bookingType"><option value="scheduled">Schedule for later</option><option value="now">Request now</option></select></label></div>
